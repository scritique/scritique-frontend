    ...
    <div className="min-h-screen">
      ...
      <section className="section-padding hero-gradient text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          {/* FAQ Accordion - Matched to FAQPage appearance */}
              ...
              <div className="space-y-4">
                {faqs.slice(0, Math.ceil(faqs.length / 2)).map((faq, index) => (
                  <motion.div
                    ...
                    className="bg-gray-50 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300 cursor-pointer overflow-hidden text-gray-900"
                    ...
                    >
                      <div className="p-6">
                        <div className="flex justify-between items-center">
                          <h3 className="text-lg font-semibold">{faq.question}</h3>
                          <svg
                            className={`w-5 h-5 transition-transform duration-300 ${openFAQIndex === globalIndex ? 'rotate-180' : ''}`}
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                          >
